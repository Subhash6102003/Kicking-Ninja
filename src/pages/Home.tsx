          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                <div className="bg-accent-blue/30 w-72 h-72 rounded-lg absolute -z-10 -bottom-5 -right-5"></div>
                <img 
                  src="/assets/images/academy.jpg" 
                  alt="Kicking Ninja Academy" 
                  className="rounded-lg shadow-xl w-full h-auto relative z-10"
                />                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-bright-red/90 p-6 rounded-lg shadow-lg z-20 w-48 h-48 flex flex-col items-center justify-center">
                  <p className="text-4xl font-bold text-soft-white font-display">10+</p>
                  <p className="text-soft-white text-center">Years of Excellence</p>
                </div>
              </div>
            </motion.div>
              <motion.div
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                <div className="flex items-start">
                  <div className="w-10 h-10 bg-deep-blue rounded-full flex items-center justify-center mr-3 flex-shrink-0 mt-1">
                  ...
                  <div>                    <h3 className="font-bold text-accent-blue mb-1">Expert Instructors</h3>
                    <p className="text-soft-white/80">Learn from record-breaking martial artists.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>                    <h3 className="font-bold text-accent-blue mb-1">Modern Facilities</h3>
                    <p className="text-soft-white/80">Train in a state-of-the-art dojo.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>                    <h3 className="font-bold text-accent-blue mb-1">Personalized Training</h3>
                    <p className="text-soft-white/80">Customized programs for all skill levels.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>                    <h3 className="font-bold text-accent-blue mb-1">Competition Ready</h3>
                    <p className="text-soft-white/80">Prepare for tournaments and championships.</p>
                  </div>
                </div>
              </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {[
              ...
              <motion.div
                key={t.name}
                className={`relative bg-soft-black p-6 rounded-lg shadow-xl border-t-4 border-${t.color}`}
              ...
              >
                <div className="flex items-center mb-4">
                  <img src={t.img} alt={t.name} className="h-12 w-12 rounded-full object-cover border-2 border-accent-blue mr-4" loading="lazy" />
                  <div>
                    <h4 className={`font-bold text-${t.color}`}>{t.name}</h4>
                    <p className="text-sm text-metallic-gray">{t.years}</p>
                  </div>
                </div>
                <p className="text-soft-white italic">{t.text}</p>
